...
public class Main {
    ...
    public static void main(String[] args) {
        User U_71190480 = new User("Daniel Adi Purwanto", "daniel.adi@ti.ukdw.ac.id", 50000);
        User U_GantiPakeNimKamu = new User("Hennoch ", "Hennoch.azarya@ti.ukdw.ac.ic", 30000);
